          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-gray-800 pb-4">
              ...
              <p className="text-gray-400 text-sm">
                ...
                and the complexity of your request. Pro and Power tier users receive priority processing.
              </p>
            </div>
            ...
            <div className="border-b border-gray-800 pb-4">
              ...
              <p className="text-gray-400 text-sm">
                Free users can download clips in standard MP4 format. Pro and Power users can access multiple formats 
                optimized for different social media platforms, including vertical (9:16), square (1:1), and 
                horizontal (16:9) videos with custom options for quality and compression.
              </p>
            </div>
            
            <div className="border-b border-gray-800 pb-4">
              <h3 className="font-medium text-white mb-2">Do I need to create an account?</h3>
              <p className="text-gray-400 text-sm">
                You can use basic features without an account. However, creating an account allows you to save your 
                clip history, access premium features, and enjoy a higher usage limit.
              </p>
            </div>
          </div>
        </div>
